    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int drawnDataPos = drawnDataStartPos + mSelectedItemPosition,
            ...
            if (mSelectedItemTextColor != -1) {
                ...
                canvas.drawText(list[0], mDrawnCenterX, drawnCenterY-80, mPaint);
                canvas.drawText(list[1], mDrawnCenterX, drawnCenterY, mPaint);
                canvas.drawText(list[2], mDrawnCenterX, drawnCenterY+80, mPaint);
                canvas.restore();
                ...
                if (isCurved) canvas.concat(mMatrixRotate);
                canvas.drawText(list[0], mDrawnCenterX, drawnCenterY-30, mPaint);
                canvas.drawText(list[1], mDrawnCenterX, drawnCenterY, mPaint);
                canvas.drawText(list[2], mDrawnCenterX, drawnCenterY+30, mPaint);
                canvas.restore();
            }
