package com.xbing.com.viewdemo.ui.customview.pulltorefresh;
...
public class PullToRefreshView extends LinearLayout{
	...
	private void addHeaderView() {
		Log.i(TAG, "PullToRefreshView-->addHeaderView");
		mHeaderView = mInflater.inflate(R.layout.refresh_header, this, false);
		mHeaderImageView = (ImageView) mHeaderView.findViewById(R.id.pull_to_refresh_image);
		measureView(mHeaderView);
		mHeaderViewHeight = mHeaderView.getMeasuredHeight();
		Log.i(TAG, "PullToRefreshView-->mHeaderViewHeight:" + mHeaderViewHeight);
	...
	private void addFooterView() {
		Log.i(TAG, "PullToRefreshView-->addFooterView");
	...
	private void initContentAdapterView() {
		...
		Log.i(TAG, "PullToRefreshView-->initContentAdapterView。count=" + count);
		if (count < 3) {
